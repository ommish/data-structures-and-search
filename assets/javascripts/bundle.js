...
var dictionary = exports.dictionary = ["aardvark", "abaci", "aback", "abacus", "abash", "abbess", "abduct", "abet", "abhor", "ablaze", "abode", "abound", "abroad", "abrupt", "acacia", "accept", "achene", "acne", "acting", "acute", "adapt", "adder", "adieux", "adjust", "adman", "admire", "admix", "adroit", "advise", "adze", "aerial", "affair", "afford", "afghan", "agate", "agenda", "agree", "ahead", "aide", "airy", "akin", "alack", "alcove", "alibi", "allied", "allow", "allude", "aloha", "alpaca", "alumni", "always", "amide", "amok", "animus", "ankh", "apish", "append", "arcade", "arena", "array", "artery", "assail", "asset", "astute", "asylum", "atlas", "atrial", "attach", "avaunt", "avowal", "award", "away", "awoken", "axiom", "axle", "azure", "babel", "bagful", "baize", "bale", "banzai", "barely", "barman", "barred", "bases", "basics", "basin", "bate", "beacon", "beady", "bean", "beard", "bebop", "bedim", "beech", "beep", "befog", "befoul", "began", "begin", "belay", "bell", "bellow", "belted", "benign", "benumb", "beryl", "bettor", "bigwig", "bionic", "biopic", "bisque", "bitty", "blase", "blaze", "bleach", "blintz", "blob", "bloom", "blurry", "boater", "boffo", "bogie", "boll", "bombed", "bond", "bony", "borax", "border", "boron", "bounce", "bowels", "boxing", "brash", "bray", "bread", "brewer", "bridal", "bridle", "broad", "broken", "brow", "bruin", "bubbly", "buddy", "buff", "bunch", "burbs", "bushy", "butch", "buyout", "bygone", "bypass", "byplay", "byte", "calico", "caller", "callus", "canard", "canyon", "caper", "carnal", "carpi", "carrel", "cartel", "casino", "casket", "catnap", "cavil", "cayman", "cedar", "cell", "censor", "cent", "chalky", "chaps", "chary", "chaser", "cheap", "chef", "chid", "chief", "chip", "chives", "choke", "chosen", "chub", "chug", "chump", "cilium", "cinder", "cite", "city", "civic", "clack", "clamp", "clan", "claque", "clew", "clingy", "cloaca", "close", "clout", "cloy", "club", "clumpy", "coach", "cobalt", "coca", "codify", "coed", "coin", "collie", "colt", "comb", "comfy", "copula", "costs", "coupe", "coupon", "course", "coven", "cowrie", "cram", "crank", "crave", "creche", "crib", "cried", "crises", "crook", "cruddy", "crumb", "cuddle", "cudgel", "cull", "curiae", "curl", "cutler", "cutter", "dace", "daffy", "dagger", "damask", "damper", "dangle", "dankly", "darned", "davit", "deafen", "debate", "debtor", "decode", "decor", "deepen", "defer", "deform", "defray", "degree", "delay", "demand", "denim", "denude", "desalt", "desk", "detach", "detox", "deuce", "devote", "dibs", "dicey", "diesel", "differ", "dilly", "dimity", "dimply", "dingy", "dint", "dipper", "dirndl", "disarm", "dismay", "dispel", "ditto", "docile", "doge", "doings", "doll", "dongle", "doping", "dork", "dotage", "doth", "dozen", "drain", "drawl", "dream", "dreamt", "drench", "drew", "drink", "dryly", "duds", "duel", "dues", "dumdum", "dune", "duper", "durum", "dybbuk", "early", "earn", "earth", "earwig", "easily", "echo", "edgy", "editor", "elate", "elder", "elixir", "emit", "enamor", "encamp", "ending", "envoy", "erupt", "evader", "event", "exam", "excite", "exit", "exotic", "exurb", "facet", "fail", "faille", "fairly", "fake", "fall", "falls", "fare", "fatal", "fauna", "faze", "fedora", "feeler", "female", "fencer", "fend", "ferule", "festal", "fettle", "fiasco", "fiche", "fief", "filch", "filly", "firmly", "fitter", "flair", "flan", "flask", "flaunt", "flay", "flesh", "flex", "fluff", "flunk", "flyway", "foam", "fodder", "foible", "food", "forbid", "fork", "fossil", "fret", "friar", "fridge", "frolic", "fruit", "fugue", "funnel", "fuzzy", "gabble", "gage", "gaiety", "gait", "gall", "gamete", "gamine", "gave", "gawky", "geese", "genie", "gibe", "ginkgo", "girl", "given", "glider", "glory", "glower", "gnaw", "goat", "goes", "going", "golfer", "gonad", "gong", "goober", "gorily", "gown", "grange", "grate", "grater", "gratis", "gravy", "great", "grimy", "griper", "groats", "groom", "groper", "grump", "guest", "gulper", "gunman", "gusty", "gyro", "hadst", "hail", "hamper", "hands", "hanger", "hankie", "hansom", "happen", "harken", "hate", "haul", "haven", "hear", "heaver", "heed", "helium", "hereof", "hermit", "heron", "hewer", "hiatus", "hinter", "hive", "hoard", "hobby", "hogtie", "holdup", "homage", "hookah", "hoops", "hooves", "hours", "hummus", "hump", "hungry", "hurl", "hybrid", "icon", "idea", "idyll", "ileum", "imbibe", "immune", "impost", "incise", "incite", "indite", "infant", "inky", "inroad", "inrush", "inset", "inside", "intake", "ireful", "iron", "isobar", "ivory", "jackal", "jacks", "jaunt", "jazzy", "jennet", "jersey", "jowl", "julep", "junket", "kappa", "kebab", "kiln", "kilt", "kiss", "kisser", "kite", "knives", "known", "labial", "lade", "lain", "lapdog", "laptop", "lariat", "latent", "lath", "laxity", "leaper", "ledger", "leery", "legit", "lemon", "lesion", "lessor", "lichee", "lieder", "linage", "linens", "lines", "lire", "lisp", "liver", "loam", "loan", "lobed", "locust", "loggia", "logy", "look", "loopy", "looter", "lose", "lucid", "luff", "lumbar", "lushly", "madam", "madman", "madras", "maize", "malice", "mambo", "manage", "maned", "manger", "mangle", "manna", "manual", "maser", "masque", "matron", "matt", "matzo", "maxima", "mayst", "meanie", "meld", "member", "memory", "merit", "midday", "middle", "miff", "milker", "mill", "millet", "mirror", "miss", "misses", "mite", "mitt", "moaner", "mocha", "mocker", "modem", "modern", "moist", "moment", "monism", "mopish", "mopy", "morn", "mossy", "motor", "mount", "move", "movies", "muddy", "muffle", "mulch", "mumps", "murky", "muse", "mushy", "muster", "myopia", "nacho", "naive", "name", "namely", "nearby", "neat", "needle", "nerd", "nisei", "nodal", "none", "noodle", "nope", "norm", "nuclei", "numb", "nurse", "oafish", "odored", "oldish", "online", "onward", "opaque", "orally", "others", "ouch", "outer", "outgo", "outing", "oval", "overt", "oxbow", "oxide", "oyster", "palely", "palsy", "paltry", "pane", "pantry", "papery", "parcel", "parent", "pate", "payee", "peak", "pearl", "peel", "peer", "pelf", "peony", "perish", "peyote", "phlox", "physic", "piece", "pierce", "piffle", "piper", "pistil", "pitch", "planet", "plat", "play", "please", "pledge", "plum", "plumb", "poke", "polish", "polity", "poll", "pompon", "pond", "pony", "poof", "poorly", "potty", "prance", "pray", "prissy", "prose", "prosy", "proxy", "psyche", "pupae", "purvey", "pushup", "quake", "quick", "quiet", "quits", "racy", "radar", "radium", "radon", "raider", "rainy", "ramjet", "ranks", "ransom", "rapid", "ratio", "rattle", "raving", "react", "rear", "rebate", "rebut", "recent", "record", "redone", "refuel", "regrew", "relaid", "remelt", "remold", "remote", "rennet", "rental", "repaid", "repay", "repel", "repine", "reply", "rescue", "resist", "rest", "retake", "retest", "retire", "reuse", "revamp", "reveal", "revel", "revile", "reword", "ricer", "rill", "risque", "roads", "roast", "rocky", "room", "rooms", "rope", "ropes", "rosily", "rote", "rotten", "rouge", "rubric", "ruling", "runny", "runs", "rupee", "russet", "sago", "sahib", "saint", "saliva", "sally", "samba", "satrap", "sawn", "schmo", "scoop", "scope", "scow", "scribe", "script", "scrub", "seaman", "season", "seaway", "sedgy", "seedy", "seer", "seize", "semi", "serous", "sesame", "sexily", "sextet", "shad", "shah", "shay", "sheath", "sheeny", "shifty", "shirt", "shod", "shop", "shrink", "sickie", "sickle", "sift", "sigh", "silage", "sill", "silt", "silver", "singe", "sinker", "sinus", "sire", "sisal", "site", "skew", "skier", "skirt", "slack", "slag", "slew", "slide", "slight", "slimy", "sloe", "slogan", "slough", "sludgy", "slug", "slyly", "smithy", "snarly", "sneak", "snipe", "snow", "snowy", "snugly", "sofa", "soil", "solid", "sorrow", "sorter", "spare", "spark", "spear", "spent", "spewer", "sphere", "spoilt", "spoken", "spongy", "spore", "spotty", "sprat", "spread", "spring", "sprint", "spur", "squall", "stack", "stanza", "steps", "still", "stir", "stodgy", "stogy", "stoked", "stolid", "story", "street", "strewn", "strict", "strip", "stump", "stupor", "suffer", "sugar", "sumach", "sumo", "sunder", "sundry", "surety", "swag", "swam", "swank", "swept", "sword", "sylvan", "taker", "talky", "tamely", "tarp", "tarpon", "tart", "taster", "tasty", "tear", "tedium", "teepee", "temple", "tennis", "tenor", "tenth", "tepee", "term", "tern", "tetra", "there", "these", "thine", "thorn", "thrift", "throe", "thrust", "thyme", "tiered", "tiling", "timber", "tingly", "titan", "today", "togaed", "tongs", "took", "torque", "totter", "toupee", "tousle", "trash", "tray", "tribe", "trill", "troika", "tropic", "trot", "trump", "trumps", "trusty", "tsar", "turban", "tutu", "twelve", "twist", "tzar", "ulnae", "unbind", "uncork", "undue", "unease", "unkind", "unlit", "unmade", "unseen", "unwise", "upland", "uppity", "uptake", "uptick", "uremic", "ursine", "utopia", "vagary", "vainly", "vase", "veiled", "venal", "verge", "verve", "vest", "vibes", "vicar", "vixen", "vodka", "volt", "walk", "walrus", "wander", "wane", "warped", "waste", "weensy", "weevil", "weigh", "went", "whaler", "wharf", "wheezy", "whelm", "whet", "whiner", "wide", "wilds", "winery", "wisdom", "wits", "wobbly", "woke", "wont", "woof", "wool", "yacht", "yank", "yeast", "yeti", "yokel", "yummy", "zephyr", "zygote"];
...
var _hashString = __webpack_require__(89);
...
var Hashmap = function () {
  function Hashmap() {
    var numLists = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;

    _classCallCheck(this, Hashmap);

    this.lists = new Array(numLists);
    for (var i = 0; i < numLists; i++) {
      this.lists[i] = new _linked_list2.default();
    }
    this.numElements = 0;
  }
  ...
  _createClass(Hashmap, [{
    ...
    value: function resize() {
      ...
      oldLists.forEach(function (list) {
        list.eachNode(function (node) {
          _this.list(node.key).appendNode(node.key, node.val);
        });
      });
    }
  }, {
    ...
    key: 'eachList',
    value: function eachList(callback) {
    ...
    key: 'numLists',
    value: function numLists() {
      return this.lists.length;
    }
  }, {
    key: 'list',
    value: function list(key) {
      return this.lists[(0, _hashString2.default)(key) % this.numLists()];
    }
  }]);
...
var LinkedList = function () {
  ...
  _createClass(LinkedList, [{
    ...
    key: "appendNode",
    value: function appendNode(key, val) {
      var newNode = new ListNode(key, val);
    ...
    key: "updateNode",
    value: function updateNode(key, val) {
...
var App = function App(_ref) {
  ...
  return _react2.default.createElement(
    ...
    null,
    _react2.default.createElement(_reactRouterDom.Route, { path: '/', component: _landing_page2.default })
  );
};
...
var _trie = __webpack_require__(86);

var _trie2 = _interopRequireDefault(_trie);

var _hashmap = __webpack_require__(88);

var _hashmap2 = _interopRequireDefault(_hashmap);

var _lru_cache = __webpack_require__(90);
...
var Binary = function (_React$Component) {
  ...
  function Binary(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Binary.__proto__ || Object.getPrototypeOf(Binary)).call(this, props));
  ...
  _createClass(Binary, [{
    ...
    value: function handleSubmit() {
      ...
      this.binarySearch(_dictionary.dictionary, this.state.searchQuery.toString().toLowerCase());
    }
  }, {
    key: 'binarySearch',
    value: function binarySearch(arr, target) {
      ...
      var probeIdx = Math.floor(arr.length / 2);
      var checked = 1;
      ...
      var _loop = function _loop() {
        ...
        var currentEnd = endIdx;
        var searching = target === arr[probeIdx] ? "Found!" : "Searching...";
        funcue.push(function () {
          _this2.setState({ inspecting: idx, currentEnd: currentEnd, currentStart: currentStart, checked: checkedWords, searching: searching });
        });

        if (target === arr[probeIdx]) {
          _this2.startBSearchAnimation(funcue);
          return {
            v: probeIdx
          };
      ...
      funcue.push(function () {
        _this2.setState({ inspecting: null, currentStart: null, currentEnd: null, searching: "Not found!" });
      });
      this.startBSearchAnimation(funcue);
      return null;
    }
  }, {
    key: 'startBSearchAnimation',
    value: function startBSearchAnimation(queue) {
      var _this3 = this;

      var bSearchInterval = window.setInterval(function () {
        queue.shift()();
        if (queue.length < 1) {
    ...
    value: function render() {
      ...
      var words = _dictionary.dictionary.map(function (word, i) {
...
var CompressedTrie = function (_React$Component) {
  ...
  _createClass(CompressedTrie, [{
    ...
    value: function componentWillMount() {
      this.root = new _tree_node2.default();
      _compressed_trie2.default.buildCompressedTrie(this.root, _dictionary.dictionary, 1);
    }
  }, {
    key: 'toJSX',
...
var HashmapDictionary = function (_React$Component) {
  _inherits(HashmapDictionary, _React$Component);

  function HashmapDictionary(props) {
    _classCallCheck(this, HashmapDictionary);

    var _this = _possibleConstructorReturn(this, (HashmapDictionary.__proto__ || Object.getPrototypeOf(HashmapDictionary)).call(this, props));
  ...
  _createClass(HashmapDictionary, [{
    key: 'handleInput',
    value: function handleInput(e) {
    ...
    value: function startHashmapSearch() {
      ...
      funcue.push(function () {
        return _this2.setState({ currentBucket: currentBucket, searching: searching1 });
      });
      if (!currentBucket) {
      ...
      var searching2 = currentBucket.isEmpty() ? "Not Found!" : "Searching...";

      if (!searching) {
        funcue.push(function () {
          return _this2.setState({ currentBucket: currentBucket, searching: searching2 });
        });
        this.startHashmapAnimation(funcue);
        return;
      }
      ...
      if (searching) {
        var searching4 = "Not found!";
        funcue.push(function () {
          return _this2.setState({ currentNode: currentNode, searching: searching4 });
        });
        this.startHashmapAnimation(funcue);
      }
    }
  }, {
    key: 'startHashmapAnimation',
    value: function startHashmapAnimation(queue) {
      var _this3 = this;

      var hashmapInterval = window.setInterval(function () {
        queue.shift()();
        if (queue.length < 1) {
    ...
    value: function componentWillMount() {
      ...
      this.dictionaryHashmap = new _hashmap2.default();
      _dictionary.dictionary.forEach(function (word) {
        _this4.dictionaryHashmap.addVal(word, true);
      });
    }
  }, {
    key: 'createList',
    value: function createList() {
      ...
      this.dictionaryHashmap.eachList(function (list, i) {
        var listWords = [];
        var j = 0;
        var bucketClass = _this5.state.currentBucket === list ? "bucket active" : "bucket";
        if (list.isEmpty()) {
        ...
        list.eachNode(function (node) {
          j++;
          var nodeClass = _this5.state.currentNode === node ? "linked-list-node active" : "linked-list-node";
          listWords.push(_react2.default.createElement(
            'li',
...
var LRUCache = function (_React$Component) {
  _inherits(LRUCache, _React$Component);

  function LRUCache(props) {
    _classCallCheck(this, LRUCache);

    return _possibleConstructorReturn(this, (LRUCache.__proto__ || Object.getPrototypeOf(LRUCache)).call(this, props));
  }
...
var LRUCache = function () {
  function LRUCache() {
    ...
    this.hashmap = new _hashmap2.default();
    this.store = new _linked_list2.default();
    this.max = max;
    this.func = func;
  }
  ...
  _createClass(LRUCache, [{
    ...
    value: function getVal(key) {
      var node = this.hashmap.findNode(key);
      if (node) {
    ...
    key: 'updateStore',
    value: function updateStore(node) {
      node.removeFromList();
      var newNode = this.store.appendNode(node.key, node.val);
      return this.hashmap.addVal(node.key, newNode);
    }
  }, {
    key: 'addToStore',
    value: function addToStore(key) {
      if (this.hashmap.numElements === this.max) {
        this.ejectNode();
      }
      var val = this.func(key);
      var newNode = this.store.appendNode(key, val);
      return this.hashmap.addVal(key, newNode);
    }
  }, {
    key: 'ejectNode',
    value: function ejectNode() {
      var toRemove = this.store.head.next;
